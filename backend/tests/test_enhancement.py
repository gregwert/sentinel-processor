...
Tests for sentinel_backend.processing.enhancement — apply_clahe and apply_gray_world.
"""

import numpy as np

from sentinel_backend.processing.enhancement import apply_clahe, apply_gray_world
