...
Tests for sentinel_backend.chipping — ChipGrid construction, window computation,
...
from sentinel_backend.chipping.gdal_chipper import compute_chip_grid, chip_affine, get_chip, build_chip_grid
from sentinel_backend.chipping.tile_exporter import _coords_filename, export_chips, zip_export
